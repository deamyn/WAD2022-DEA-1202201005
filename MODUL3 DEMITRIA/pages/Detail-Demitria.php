...
$sql = "SELECT * FROM showroom_dea_table WHERE id_mobil = $id";
    ...
    <section id='detail'>
        ...
        while ($getDetail = mysqli_fetch_array($result)) {
            echo "
                    ...
                    <img src='../assets/images/" . $getDetail["foto_mobil"] . "' alt='foto_mobil'>
                    <form action='' enctype='multipart/form-data'>
                        ...
                        <a href='Edit-Demitria.php?id=" . $getDetail["id_mobil"] . "' class='btn' style='margin-top: 40px; background-color: #FFE1E1'>Edit</a>
                    </form>
                    </div>
                ";
        }
