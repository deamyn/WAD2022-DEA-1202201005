    ...
    <div class="container">
      @auth
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  <img src='{{ url('storage/'.$showroom->image) }}' alt='foto_mobil' style="border-radius: 25px;">
                  <form action='{{ url('/detail/'.$showroom->id) }}' method="POST" enctype='multipart/form-data'>
                    ...
                    <button type="submit" class='btn' style='background-color: #FFE1E1; margin-top: 40px;'>Edit</button>
                  </form>
                </div>
        @endauth
    </div>
